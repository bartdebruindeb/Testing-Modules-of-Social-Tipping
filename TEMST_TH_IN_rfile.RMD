...
g_plot <- ggplot() +
    #geom_histogram(binwidth=0.01)+
  #    geom_point(data=df_use, aes(x = IO_Ratio_N, y =MPL, color = Tipping_Strategy ), size = 0.5) + 
   geom_point(data=df_use, aes(x = !!ensym(p), y = Green_Percentage, color = Ratio_Influencers_Green), size =0.8) + 
